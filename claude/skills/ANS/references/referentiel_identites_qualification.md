...
### Voie A — Assumer le statut de référentiel d'identités
...
### Voie B — Se positionner comme logiciel non référentiel d'identités
...
### Voie C — Argumenter qu'on n'est pas dans le cercle de confiance ❌ À éviter
